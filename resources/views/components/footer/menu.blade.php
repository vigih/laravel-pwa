...
@endphp
<x-footer.fixed
    class="footer-menu flex p-2 overflow-x-auto scrollbar-hidden z-[1000] bg-white shadow-md border-t-[1px] border-gray-200">
    <div class="flex items-center">
        @foreach ($items as $item)
            ...
            <div class="menu-item flex-[0_0_auto] flex flex-col justify-center items-center p-1 mr-3"
