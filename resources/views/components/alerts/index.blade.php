{{-- resources/views/components/alerts/index.blade.php --}}
...
@php
    ...
    $typeClass = $variants[$type] ?? $variants['primary'];

    $classed = trim("$baseClass $typeClass $class");

@endphp

<x-alerts.base class="{{ $classed }}">
    {{ $message ?: $slot }}
    <x-alerts.dismiss />
</x-alerts.base>
