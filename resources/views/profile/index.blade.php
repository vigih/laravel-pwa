    ...
    <x-slot name="section">
        <x-layouts.section class="mt-[80px] !p-0">
            <x-modals.modal :title="__('Ubah Profile')" class="!p-0">
                <x-slot name="trigger">
                    <x-lists.list-item-action :label="__('Ubah Profile')" :icon="__('perm_identity')" type="button" @click="open = true" />
                </x-slot>
                <x-slot name="content">
            ...
            <x-modals.modal :title="__('Ubah Password')" class="!p-0">
                <x-slot name="trigger">
                    <x-lists.list-item-action :label="__('Ubah Password')" :icon="__('key')" type="button" @click="open = true" />
                </x-slot>
                <x-slot name="content">
